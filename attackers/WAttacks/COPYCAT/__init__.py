...
# from ThirdParty.PGD.PGD import PGD
...
#         adverisalExamples_labels = clsf(adverisalExamples.to('cpu'))
#         isAdverisalExamples = np.array(adverisalExamples_labels.cpu() != labels.cpu())
#         isSuccessAdversialExamples = isAdverisalExamples

#         paddingAEs = np.concatenate((imagesOriginal.cpu(), adverisalExamples.cpu()), axis=2)
#         paddingAEs = resize(torch.from_numpy(paddingAEs))
#         paddingAEs_labels = clsf(paddingAEs.to('cpu'))
#         isExecAEsP = np.array(paddingAEs_labels.cpu() != labels.cpu())
