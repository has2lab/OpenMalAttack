...
"""
DataInstList = ['dd', 'db', 'dw', 'dq', 'dt', 'extrn', 'unicode']
DataInstDict = {k: v for v, k in enumerate(DataInstList)}

CallingInstList = ['call', 'int', 'into', 'syscall', 'sysenter']
CallingInstDict = {k: v for v, k in enumerate(CallingInstList)}

ConditionalJumpInstList = [
    'ja', 'jb', 'jbe', 'jcxz', 'jecxz', 'jg', 'jge', 'jl', 'jle', 'jnb', 'jno', 'jnp', 'jns', 'jnz',
    'jo', 'jp', 'js', 'jz', 'loop', 'loope', 'loopne', 'loopw', 'loopwe', 'loopwne']
...
EndHereInstList = [
    'end',
    'iret', 'iretw', 'iretq',
    'retf', 'reti', 'retfw', 'retfq', 'retn', 'retnw',
    'sysexit', 'sysret',
    'xabort',
]
...
RegularInstList = [
    ...
    'btr', 'bts',
    'cbw', 'cdq', 'cdqe', 'clc', 'cld', 'clflush', 'cli', 'clts', 'cqo',
    ...
    'cmpsb', 'cmpsd', 'cmpsw', 'cmpsq', 'cmpxchg', 'comisd',
    ...
    'movntps', 'movntq', 'movq', 'movs', 'movsb', 'movsd', 'movsq',
    'movss', 'movsw', 'movsx', 'movsxd', 'movups', 'movzx', 'mpsadbw',
    ...
    'pmullw', 'pmuludq', 'pop', 'popa', 'popaw', 'popf', 'popfq',
    'popfw', 'por', 'vpor', 'pqit', 'prefetch', 'prefetchnta',
    ...
    'stmxcsr', 'stos', 'stosb', 'stosd', 'stosq',
    ...
    'vmlaunch', 'vmmcall', 'vmcall', 'vmovhlps', 'vmovlps', 'vmovq',
...
MathInstList = [
    ...
    'vpaddw', 'vpandn', 'vpand', 'vpclmulqdq', 'vpermilps', 'vpermq',
    'vpextrw', 'vpinsrw', 'vpmaddwd', 'vpmaxub', 'vpmulhuw',
    'vpmulhw', 'vpmullw', 'vpsadbw', 'vpshufhw', 'vpshufb', 'vpshuflw',
    'vpsllq', 'vpsllw', 'vpsrad', 'vpsrld', 'vpsrlq',
...
MovInstList = [
    ...
    'movss', 'movsw', 'movsx', 'movsq', 'movsxd', 'movups', 'movzx',
    'movntpd', 'movupd',
