...
# @File : main.py
import re
from utils.magic.get_graph.instructions_data import *
from typing import List, Set
from utils.magic.get_graph.dp_utils import findAddrInOperators
...
class Instruction(object):
    ...
    operatorTypes = {'num_const': len(operandTypes), 'str_const': len(operandTypes) + 1}
