# # TODO: * modify exports using lief * zero out rich header (if it exists) --> requires updating OptionalHeader's
# #  checksum ("Rich Header" only in Microsoft-produced executables) * tinker with resources:
# #  https://lief.quarkslab.com/doc/tutorials/07_pe_resource.html
...
#         upper = random.randrange(256)
#         targeted_section.content = targeted_section.content.tolist() + \
